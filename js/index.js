...
$(document).ready(function() {
    ...
    fetch('info.json')
        ...
        .then(result => {
            ...
            pastEvent.slice((pastEvent.length - limitEvents), pastEvent.length)
                .forEach(event => {
                    viewEvent(event, 'pasados');
                });


            upcomingEvents.slice(0, limitEvents)
                .forEach(event => {
